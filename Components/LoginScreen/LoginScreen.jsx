...
export default function LoginScreen({ navigation }) {
    ...
    const loginFormSubmitted = async (username, password) => {    
        ...
        setIsLoading(false);
        return navigation.navigate("Dashboard", { student: { ...student, finalWeightedGPA: 0, finalUnweightedGPA: 0 } })
        ...
        const { finalWeightedGPA, finalUnweightedGPA } = await getPredictedGPA(student).catch((error) => console.log(error));
